    ...
    <div className='relative h-dvh w-screen overflow-x-hidden'>
        ...
        <div>
            ...
            <div onClick={HandleMiniVidClick} className="origin-center scale-50 opacity-0 transition-all duration-500 ease-in hover:scale-100 hover:opacity-100">
                <video 
                ref={nextVdRef}
                src={getVdSource(upcomingVdIndex)}
                loop
                muted
                id='current-video'
        ...
        <video 
            src={getVdSource(currentIndex == totalVideos - 1 ? 1 : currentIndex)}
            autoPlay
            loop
            muted
        ...
        />
            ...
            <div className='absolute left-0 top-0 z-40 size-full'>
                <div className='mt-24 px-5 sm:px-25'>
                    <h1 className='special-font hero-heading text-blue-100'>redefi<b>n</b>e</h1>
                    <p className='mb-5 max-w-64 font-robert-regular text-blue-100'> Enter the Metagame Layer <br/> Unleash the Play Economy</p>
                    <Button id= "watch-trailer" title="Watch-Trailer" leftIcon={<TiLocationArrow />} containerClass="!bg-yellow-300 flex-center gap-1 rounded-full"/>
                </div>
